//
//  PFGLKitLineSampleViewController.m
//  GLKitSampler
//
...
#import "PFGLKitLineSampleViewController.h"
...
@interface PFGLKitLineSampleViewController () <UIGestureRecognizerDelegate>
{
...
@implementation PFGLKitLineSampleViewController
...
- (void)viewDidLoad
{
    NSLog(@"PFGLKitLineSampleViewController -viewDidLoad");
...
- (void)glkView:(GLKView *)view drawInRect:(CGRect)rect
{
    ...
    glDrawArrays(GL_LINE_STRIP, 0, 4); // For line.
}
